...
const Home: FC<{}> = () => {
  return (
    <div className=" flex flex-col justify-center items-center h-screen pb-10">
      ...
      <div className={cn({
        "block  min-w-[200px] max-w-[300px] rounded-full  p-1 mb-5": true,
        "animate-steam": true
      })} >
        <Image
          alt=""
      ...
      <h1 className="text-5xl  mt-5 ">Hello, I&lsquo;m Reymart!</h1>
      <div className="p-5 mt-5 text-xl text-center max-w-[800px]">
